...
ShaguDB_VARIABLES_LOADED:SetScript("OnEvent", function(self, event, ...)
    ...
    ShaguDB_MAP_NOTES = {};
    ShaguDB_Print("|cff33ff88ShaguDB|cffffffff 7.2 |cffaaaaaa [deDE]");
...
SlashCmdList["SHAGU"] = function(input, editbox)
  ...
  if (input == "" or input == nil) then
    ShaguDB_Print("|cff33ff88ShaguDB|cffffffff 7.2 |cff00ccff[" .. UnitFactionGroup("player") .. "]|cffaaaaaa [deDE]");
